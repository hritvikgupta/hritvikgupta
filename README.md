...
xychart-beta
    ...
    x-axis [Sep, Oct, Nov, Dec, Jan, Feb, Mar, Apr, May, Jun, Jul, Aug]
    y-axis "Contributions" 0 --> 84
    bar [0, 0, 10, 75, 25, 14, 7, 36, 2, 15, 21, 16]
```

| | Total contributions | Current streak | Longest streak | Last 12 months |
|---|---|---|---|---|
| **Activity** | **1,559** <br /><sub>Jan 21, 2020 – present</sub> | **2** days <br /><sub>Aug 4, 2026 – Aug 5, 2026</sub> | **18** days <br /><sub>May 18, 2022 – Jun 4, 2022</sub> | **221** |
| **Presence** | **160** repositories | **18** stars earned | **8** followers | **6** years on GitHub |
